...
<?php $date=str_split($row['created'],10);?> 
   <p><i class="fa fa-chevron-right"></i><?="Issue Created on ";?><?=$date[0];?><?=" at ";?><?=$date[1];?><?=" by ";?><?=$results2[0]['firstname'];?><?=" ", $results2[0]['lastname'];?></p>

<?php $date1=str_split($row['updated'],10);?> 
   <p><i class="fa fa-chevron-right"></i><?="Last Updated on ";?><?=$date1[0];?><?=" at ";?><?=$date[1];?></p>
</div>
 <?php endforeach; ?>
...
<div class="info">
<?php $date=str_split($row['created'],10);?> 
 <p><i class="fa fa-chevron-right"></i><?="Issue Created on ";?><?=$date[0];?><?=" at ";?><?=$date[1];?><?=" by ";?><?=$results3[0]['firstname'];?><?=" ", $results3[0]['lastname'];?></p>

<?php $date1=str_split($row['updated'],10);?> 
<p><i class="fa fa-chevron-right"></i><?="Last Updated on ";?><?=$date1[0];?><?=" at ";?><?=$date1[1];?></p>
</div>
 <?php endforeach; ?>
