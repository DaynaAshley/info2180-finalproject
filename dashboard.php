...
<?php if($context=='all'){?>
 <table class= "ctable">
  ...
  <?php if($row['status']=="Open"){ ?>
      <td class="stat"><button class='open'><?=$row['status'];?></button></td>
  <?php } ?> 
  
  <?php if($row['status']=="Closed"){ ?>
    <td class="stat"><button class='closed'><?=$row['status'];?></button></td>
  <?php } ?> 

  <?php if($row['status']=="In Progress"){ ?>
    <td class="stat"><button class='progress'><?=$row['status'];?></button></td>
  <?php } ?> 
